...
CREATE TABLE IF NOT EXISTS sherbet.settings(id INTEGER PRIMARY KEY DEFAULT 1 CHECK(id=1),force_open BOOLEAN NOT NULL DEFAULT false,main_close INTEGER NOT NULL DEFAULT 780,bake_close INTEGER NOT NULL DEFAULT 780,menu_updated_day DATE);
ALTER TABLE sherbet.settings ALTER COLUMN main_close SET DEFAULT 780;
ALTER TABLE sherbet.settings ALTER COLUMN bake_close SET DEFAULT 780;
